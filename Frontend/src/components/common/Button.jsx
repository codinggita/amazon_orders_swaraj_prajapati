...
const Button = React.forwardRef(({ variant = 'primary', size = 'md', loading, disabled, icon: Icon, children, className, ...rest }, ref) => {
  const baseClasses = 'font-btn inline-flex items-center justify-center gap-2 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-red-500/40 disabled:opacity-50 disabled:cursor-not-allowed';
