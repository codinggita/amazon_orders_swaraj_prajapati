...
export default function CustomersPage() {
  ...
  return (
    <>
      <SEO
        title="Customers"
        description="Manage and analyze your customer base. View top customers by spend, order history, and geographic distribution."
        url="/customers"
        keywords="customer management, top customers, customer analytics, buyer insights"
      />
      <div>
        <PageHeader 
          label="CRM" 
