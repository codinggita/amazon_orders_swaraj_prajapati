...
export default function SearchPage() {
  ...
  return (
    <>
      <SEO
        title="Search Orders"
        description="Search across all your Amazon orders by customer name, product, category, brand, status, location, or date range."
        url="/orders/search"
        keywords="search orders, find order, order lookup, amazon order search"
      />
      <div>
