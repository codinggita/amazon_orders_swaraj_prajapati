...
export default function TrendingPage() {
  ...
  return (
    <>
      <SEO
        title="Trending Products & Categories"
        description="Discover trending products and categories based on order frequency, revenue, and customer demand analysis."
        url="/trending"
        keywords="trending products, popular categories, top selling, product trends"
      />
      <div>
