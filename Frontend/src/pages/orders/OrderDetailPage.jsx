  ...
  return (
    <>
      <SEO
        ...
        description={order
          ? `Order ${order.OrderID} for ${order.CustomerName} - ${order.ProductName}. Status: ${order.OrderStatus}. Amount: ${order.TotalAmount}`
          : 'View complete order details including product info, payment, and shipping status.'}
        url={`/orders/${orderId}`}
        noIndex={true}
      />
      <div>
