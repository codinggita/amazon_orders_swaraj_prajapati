const passport = require('passport'); 
 ...
 if (process.env.GOOGLE_CLIENT_ID) {
   ...
   console.warn('Passport Google OAuth Strategy skipped: GOOGLE_CLIENT_ID is not configured in environment.');
 }
 ...
 if (process.env.FACEBOOK_APP_ID) {
   ...
   console.warn('Passport Facebook OAuth Strategy skipped: FACEBOOK_APP_ID is not configured in environment.');
 }
